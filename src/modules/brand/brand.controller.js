...
folder: `EcommerceC42/brands/${customId}`
  ...
  newbrand ? res.status(201).json({ msg: "done", brand: newbrand })
    : next(new AppError("brand not created", 500));
};

export const addBrand = asyncHandler(addB);


// =========================================== updateBrand ===========================================

const updateB = async (req, res, next) => {
...
export const updateBrand = asyncHandler(updateB);
